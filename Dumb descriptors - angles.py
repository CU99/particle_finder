# -*- coding: utf-8 -*-
"""
Created on Thu Jan 30 18:23:08 2020
...
def find_param(coords,L,d):    
    ...
    for i, a in enumerate(coords):
        ...
        ref = nearest_neighbours[0]
        other_vectors=nearest_neighbours[1:]
        #find angle between other vectors and reference vector
        for i in other_vectors:
            v = find_vector(ref,i,L)
    ...
    with open('liquid1.8_angles.txt','ab') as file:
